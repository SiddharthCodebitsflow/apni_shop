                ...
                if (data.status == 200) {
                    for (var i in data.data) {
                        $('.card-box').append(
                            ...
                            '</h5> <div class="row"><div class="col-6"><p class="card-text mt-1"><s>Rs.' +
                            data.data[i].regular_price +
                            '</s></p></div><div class="col-6"><p class="card-text mt-1">Rs.' +
                            data.data[i].vendor_price +
                            '</p></div></div><p class="card-text"></p><div class="row"><div class="col-12"><a href="/user-about-product/' +
                            data.data[i].id +
                            '" class="btn bg-custome text-white mt-1">Go to Details Page</a></div> </div> </div> </div>'
                            );
                    }
                } else {
